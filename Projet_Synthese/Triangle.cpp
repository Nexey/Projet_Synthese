...
Triangle::Triangle(const int& c, const Vecteur2D& p1, const Vecteur2D& p2, const Vecteur2D& p3) : FormeGeoSimple("Triangle", c), p1(p1), p2(p2), p3(p3) {}

Triangle::Triangle(const Triangle &t) : FormeGeoSimple(t.getDesig(), t.getCouleur()), p1(t.getP1()), p2(t.getP2()), p3(t.getP3()) {}
